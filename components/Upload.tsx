      ...
      <div className="flex  justify-center items-center ">
        <div className="mx-auto mt-10 flex justify-center px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8">
          <div className="text-center ">
            <h1 className="text-4xl font-extrabold tracking-tight  dark:text-white/95 sm:text-5xl md:text-6xl">
              <span className="block xl:inline">
                <span className="mb-1 block">ColorCapturer: </span>
                <span className="bg-gradient-to-r from-indigo-400 to-pink-600 bg-clip-text text-transparent">
                  Where Colors Come Alive.
                </span>
              </span>
              <div className="mt-2  dark:text-white/95">
